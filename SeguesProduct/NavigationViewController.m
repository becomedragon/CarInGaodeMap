...
- (void)initNavigationBar
{
    ...
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"返回" style:UIBarButtonItemStyleBordered target:self action:@selector(navigationBack)];
...
-(id)initWithStartCoordinate:(CLLocationCoordinate2D)startPoint andDestinationCoordinate:(CLLocationCoordinate2D)endPoint{
    ...
    if (self = [super init]) {
        ...
        self.destinationCoordinate = endPoint;
    }
